            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        ...
                        <h6 class="mb-4">Binanace QrCode </h6>
                        <div class="card bg-transparent" >
                            <img class="card-img-top" src="binanace.jpeg" alt="Card image cap">
                            <form action="{{route('UploadDocuments')}}" method="post" enctype="multipart/form-data">
                                @csrf

                            <div class="card-body">
                              <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Attach Deposit Proof</label>
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <form action="{{route('UploadDocuments')}}" method="post" enctype="multipart/form-data">
                                @csrf
                            <div class="card bg-transparent" >
                                <img class="card-img-top" src="/mobilepay.jpeg" alt="Card image cap">
                                <div class="card-body">
                                  <h5 class="card-title">Mobilepay Pay </h5>
                                  <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Attach Deposit Proof</label>
                                    <input type="file" name="image" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp">
