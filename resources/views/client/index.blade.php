...
<head>
    ...
    <title>WebTrader Dashboard</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.0/dist/css/bootstrap.min.css" rel="stylesheet">
    {{-- <link rel="stylesheet" href="https://thinkmarket.es/forex.css"> --}}
...
<body id="headdd">
    ...
    <div class="container-fluid h-100">
        <div class="row h-100 ">
            ...
            <nav id="sidebar" class="col-3 d-lg-block d-none col-sm-2 col-md-1 col-lg-1 bg-light sidebar">

                <div id="sidebarContents " class=" d-none  d-lg-block">
                    <ul class="nav sidebarul flex-column">
            ...
            <main id="mainContent" class=" col-md-11 bordergiveparent   col-lg-11 col-sm-12 col-12 ">
                <div id="firstcontent" class="row bordergive align-items-center firstrow text-dark">
                    <div class="dropdown">
                            ...
                            <div class="card-body">
                                ...
                                <div class="main1 mb-4">
                                    <div class="d-flex justify-content-between align-items-center ">
                                        <p class="card-title px-3 fw-900">Forex Infotech</p>
                                        <div>
                                            <i style="font-size:24px;" onclick="logout()"
                                                class=" mt-3 fas fa-sign-out-alt"></i>
                                        </div>
                                    </div>
                                    <h5 class="px-3"> 758837 - Live</h5>

                                </div>
                                <div class="d-flex flex-column mr-3">
                                    <span class="text-center tex me-3">User Profile</span>
                                    <p class="text-center tex me-3" style="color: green;">{{ Auth::user()->account_Id }}
                                        - {{ Auth::user()->name }}</p>
                                </div>
                                <div class="mb-2 px-3 border-top-0 py-1 profile">
                                    <i class="fas fa-user" style="color: grey;"></i>

                                    <a style="text-decoration: none; color: black;" href="/change-login">Change
                                        Password</a>
                                </div>
                                ...
                                <div class="mb-2 border-top-0 px-3 py-1 profile">
                                    ...
                                    <a style="text-decoration: none; color: black;" href="/login">Connect to
                                        Account</a>
                                </div>
                                ...
                                <div class="custom-control custom-switch border-top-0 border-bottom-0 px-3 py-1 profile"
                                    ...
                                    <label onclick="deposit()" style="color: green;">Deposit</label>
                                </div>
                                <div class="custom-control custom-switch border-top-0 border-bottom-0 px-3 py-1 profile"
                                    id="themeToggle">
                                    <i class="fas fa-dollar-sign mr-2"></i>
                                    <label onclick="deposit()" style="color: red;">Withdrawal</label>
                                </div>
                        ...
                        <div id="marketExecutionDropdown" class="dropdown-menu dropdown-container rounded-0"
                            ...
                            <div class="d-flex justify-content-between mt-2 d-block d-lg-none px-3">
                                <div class="text-center ersd">
                                    BTCUSD
                                </div>
                            ...
                            <div
                                class="d-flex mb-3 d-lg-flex d-none innerdropdown justify-content-between align-items-center">
                            ...
                            <div class="content1">
                                ...
                                <div class="d-flex mt-3 justify-content-between">
                                    ...
                                    <div style="width: 50%;" class="option">
                                        ...
                                        <div class="control innervolume1 innervolume">
                                            <a onclick="decrementValue('takeprofit')">
                                                <i style="font-size: 14px;" class="fas fa-minus"></i>
                                            ...
                                            <a onclick="incrementValue('takeprofit')">
                                                <i style="font-size: 14px;" class="fas fa-plus"></i>
                                ...
                                <input class="innervolume w-100 mb-3 in mt-3" type="text" type="text"
                                    name="comment">
                                ...
                                <div class="prices text-center">
                                    <div style="font-size: 14px;" class="order_sell_price"></div>
                                    <div style="font-size: 14px;" class="order_buy_price"></div>
                                </div>
                                <div class="buttons-row">
                                    <button style="font-size: 14px;" class="sell333" type="submit" name="action"
                                        value="sel_market">Sell by Market</button>
                                    <button style="font-size: 14px;" class="buy333" type="submit" name="action"
                                        value="buy_market">Buy by Market</button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="main1 mb-4">
                                    <div class="d-flex  align-items-center ">
                                        <p class="card-title px-3 fw-900">ETCGLOBALS</p>
                                        <div>
                                            <i style="font-size:24px;" onclick="logout()"
                                                class=" mt-3 fas fa-sign-out-alt"></i>
                                        </div>
                    ...
                    <div class="col-1 no1 col-md-3 col-sm-3 justify-content-center f d-flex align-items-center">
                        ...
                        {{-- <li id="margingiving2" class="nav-item dropdown rightline">
                    ...
                    <div id="margingiving"
                        ...
                        {{-- <li class="nav-item dropdown toshow speciali rightline  ">
                        ...
                        <svg class="one1 " onclick="toggleDropdown()" width="24" height="24"
                        ...
                        <li class="rightline one2" style="display: none;">
                            <svg class="" onclick="toggledropdownmobile()" width="24" height="24"
                                viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <g fill="none" fill-rule="evenodd">
                                    <path fill="#DA5244"
                                        d="M11.5 4v2.02C8.42 6.276 6 8.856 6 12c0 3.145 2.42 5.725 5.5 5.98V20H10c-4.418 0-8-3.582-8-8s3.582-8 8-8h1.5z">
                        ...
                        <svg class="tohide" onclick="toggleCard()" width="24" height="24"
                            viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div id="hiddingit"
                        ...
                        <div class="d-flex flex-column mr-3">
                            ...
                            <p class="tex1">{{ Auth::user()->account_Id }}</p>
                        </div>

                        <div class="d-flex flex-column mr-3">
                            <span class="tex me-3">Balance</span>
                            <p class="tex1">{{ Auth::user()->bal }} &nbsp;&nbsp;&nbsp;</p>
                        </div>

                        <div class="d-flex flex-column mr-3">
                            <span class="text-center tex me-3">Equity</span>
                            <p class="tex1" id="equity"></p>
                        </div>
                ...
                <div class="row viewss mt-lg-0 ">
                    ...
                    <div id="widgetmobilescreen"
                        ...
                        <script type="text/javascript">
                            ...
                            createTradingViewWidget('light', "EURUSD");
                        </script>
                    </div>
                    <!-- TradingView Widget END -->


                    <div id="mainCard" class="card col-lg-4 col-md-8 col-sm-12 col-12 ">
                        <div class="card-body">
                            ...
                            <div class="dropdown-card" id="dropdownCard">
                                ...
                                <div class="dropdown-row">
                                    <span class="word"><span onclick="showThirdDropdown(event)">Spot
                                            Metals</span></span>
                                ...
                                <div class="dropdown-row">
                                    <span class="word"><span onclick="showFifthDropdown(event)">Stock Indices
                                            (CFDs)</span></span>
                                    <span class="count">15</span>
                                </div> --}}
                                <div class="dropdown-row">
                                    <span class="word"><span
                                            onclick="showSixthDropdown(event)">Cryptos</span></span>
                            ...
                            <div class="dropdown-card6" id="dropdowncard6">
                                ...
                                <div class="dropdown-row1">
                                    ...
                                    <div class="description1"> BTC </div>
                                </div>

                                <div class="dropdown-row1">
                                    <div class="dropdown-row2">
                                        <span class="description">ethereum</span>
                                        <button class="toggle-btn" onclick="toggleIcon(this)"><i
                                                class="fas fa-plus"></i></button>
                                    </div>
                                    <div class="description1"> ETH</div>
                                </div>

                                <div class="dropdown-row1">
                                    <div class="dropdown-row2">
                                        <span class="description">bitcoin-cas</span>
                                        <button class="toggle-btn" onclick="toggleIcon(this)"><i
                                                class="fas fa-plus"></i></button>
                                    </div>
                                    <div class="description1"> BCH</div>
                                </div>
                                <div class="dropdown-row1">
                                    <div class="dropdown-row2">
                                        <span class="description">eos</span>
                                        <button class="toggle-btn" onclick="toggleIcon(this)"><i
                                                class="fas fa-plus"></i></button>
                                    </div>
                                    <div class="description1"> EOS</div>
                                </div>
                                <div class="dropdown-row1">
                                    <div class="dropdown-row2">
                                        <span class="description">litecoin</span>
                                        <button class="toggle-btn" onclick="toggleIcon(this)"><i
                                                class="fas fa-plus"></i></button>
                                    </div>


                                    <div class="description1">LTC</div>
                                </div>
                                <div class="dropdown-row1">
                                    <div class="dropdown-row2">
                                        <span class="description">cardano</span>
                                        <button class="toggle-btn" onclick="toggleIcon(this)"><i
                                                class="fas fa-plus"></i></button>
                                    </div>
                                ...
                                <div class="dropdown-row1">
                                    <div class="dropdown-row2">
                                        <span class="description">tether</span>
                                        <button class="toggle-btn" onclick="toggleIcon(this)"><i
                                                class="fas fa-plus"></i></button>
                                    </div>
                                    <div class="description1">USDT </div>
                                </div>
                                {{-- More Symbols  --}}
                                <div class="dropdown-row1">
                                    <div class="dropdown-row2">
                                        <span class="description">iota</span>
                                        <button class="toggle-btn" onclick="toggleIcon(this)"><i
                                                class="fas fa-plus"></i></button>
                                    </div>
                                    <div class="description1">MIOTA </div>
                                </div>
                                ...
                                <div class="dropdown-row1">
                                    <div class="dropdown-row2">
                                        <span class="description">monero</span>
                                        <button class="toggle-btn" onclick="toggleIcon(this)"><i
                                                class="fas fa-plus"></i></button>
                                    </div>
                                    <div class="description1">Monero </div>
                                </div>

                                <div class="dropdown-row1">
                                    <div class="dropdown-row2">
                                        <span class="description">bnb</span>
                                        <button class="toggle-btn" onclick="toggleIcon(this)"><i
                                                class="fas fa-plus"></i></button>
                                    </div>
                                    <div class="description1">BNB </div>
                                </div>
                                <div class="dropdown-row1">
                                    <div class="dropdown-row2">
                                        <span class="description">Solana</span>
                                        <button class="toggle-btn" onclick="toggleIcon(this)"><i
                                                class="fas fa-plus"></i></button>
                                    </div>
                                    <div class="description1">SOL </div>
                                </div>
                                <div class="dropdown-row1">
                                    <div class="dropdown-row2">
                                        <span class="description">Pi</span>
                                        <button class="toggle-btn" onclick="toggleIcon(this)"><i
                                                class="fas fa-plus"></i></button>
                                    </div>
                                    <div class="description1">PI</div>
                                </div>
                                <div class="dropdown-row1">
                                    <div class="dropdown-row2">
                                        <span class="description">wrapped eth</span>
                                        <button class="toggle-btn" onclick="toggleIcon(this)"><i
                                                class="fas fa-plus"></i></button>
                                    </div>
                                    <div class="description1">WETH</div>
                                </div>
                                <div class="dropdown-row1">
                                    <div class="dropdown-row2">
                                        <span class="description">dogecoin</span>
                                        <button class="toggle-btn" onclick="toggleIcon(this)"><i
                                                class="fas fa-plus"></i></button>
                                    </div>
                                    <div class="description1">DOGE</div>
                                </div>
                                <div class="dropdown-row1">
                                    <div class="dropdown-row2">
                                        <span class="description">Aave</span>
                                        <button class="toggle-btn" onclick="toggleIcon(this)"><i
                                                class="fas fa-plus"></i></button>
                                    </div>
                                    <div class="description1"> AAVE</div>
                                </div>
                                <div class="dropdown-row1">
                                    <div class="dropdown-row2">
                                        <span class="description">neo</span>
                                        <button class="toggle-btn" onclick="toggleIcon(this)"><i
                                                class="fas fa-plus"></i></button>
                                    </div>
                                    <div class="description1">NEO </div>
                                </div>
                                <div class="dropdown-row1">
                                    <div class="dropdown-row2">
                                        <span class="description">lido staked eth</span>
                                        <button class="toggle-btn" onclick="toggleIcon(this)"><i
                                                class="fas fa-plus"></i></button>
                                    </div>
                                    <div class="description1">STETH</div>
                                </div>
                                <div class="dropdown-row1">
                                    <div class="dropdown-row2">
                                        <span class="description">Bittensor</span>
                                        <button class="toggle-btn" onclick="toggleIcon(this)"><i
                                                class="fas fa-plus"></i></button>
                                    </div>
                                    <div class="description1">TAO</div>
                                </div>
                                <div class="dropdown-row1">
                                    <div class="dropdown-row2">
                                    ...
                                    <div class="description1">ETC</div>
                                </div>
                                <div class="dropdown-row1">
                                    <div class="dropdown-row2">
                                        <span class="description">Wrapped BNB</span>
                                        <button class="toggle-btn" onclick="toggleIcon(this)"><i
                                                class="fas fa-plus"></i></button>
                                    </div>
                                    <div class="description1">WBNB</div>
                                </div>
                                ...
                                <div class="dropdown-row1">
                                    ...
                                    <div class="description1">Dash </div>
                                </div>

                                <div class="dropdown-row1">
                                    <div class="dropdown-row2">
                                        <span class="description">decred</span>
                                        <button class="toggle-btn" onclick="toggleIcon(this)"><i
                                                class="fas fa-plus"></i></button>
                                    </div>
                                    <div class="description1">Decred</div>
                                </div>
                                <div class="dropdown-row1">
                                    <div class="dropdown-row2">
                                        <span class="description">maker</span>
                                        <button class="toggle-btn" onclick="toggleIcon(this)"><i
                                                class="fas fa-plus"></i></button>
                                    </div>
                                    <div class="description1">Maker </div>
                                </div>
                                <div class="dropdown-row1">
                                    <div class="dropdown-row2">
                                ...
                                <div class="dropdown-row1">
                                    <div class="dropdown-row2">
                                        <span class="description">digibyte</span>
                                        <button class="toggle-btn" onclick="toggleIcon(this)"><i
                                                class="fas fa-plus"></i></button>
                                    </div>
                                    <div class="description1">DGB </div>
                                </div>
                            ...
                            <div id="searchh" class="searchbottom " style="background-color: wht;">
                                ...
                                <div style="background-color:  white; overflow-y: scroll;"
                                    id="contentRows">
                        ...
                        <tbody>
                            @foreach ($orders as $order)
                                <tr>
                                    ...
                                    <input type="hidden" id="profit_{{ $order->id }}" value=""
                                        name="users_profit">
                                    <input type="hidden" id="current_{{ $order->id }}" value=""
                                        name="current_price">
                                    <td id="symbol_{{ $order->id }}" data-value="{{ $order->profit }}"
                                        data-column="Profit">
                                        <div class="towhite todark">
                                            <div class="towhite todark">
                                                <span
                                                    class="boldtext bg-transparent 
                                            @if ($loop->iteration % 2 == 1) notbuy 
                                            @elseif($loop->iteration % 2 == 0) notsell @endif">{{ $order->profit }}
                                                </span>
                                            </div>
                                        </div>
                                    </td>
                                    <td data-column="Comment">{{ $order->comment }}</td>
                                    <td data-column="Comment" onclick="stop_order({{ $order->id }})"> <i
                                            style=" color: skyblue;" class="fas fa-times"></i></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
                ...
                <div id="trademobilepage" class="trademobilepage" style="padding: 1rem; font-size: 1rem;">
                    ...
                    <div onclick="hideit()" style="text-align: left; color: blue; margin-bottom: 0.5rem;">
                        <span class="boldtext">Orders</span>
                    </div>
                    <div class="div1" style="background-color: blue; margin-top:30px; height: 3px; width:50px;">
                    </div>

                    <!-- Centered -1.64 EUR -->
                    <div onclick="hideit()" class="togivered"
                        style="text-align: center; color: red; margin-bottom: 0.5rem;">
                        <span class="smtext">
                            <h3 style="color:red " class="smtext1"> {{ Auth::user()->bal }} USD</h3>
                        </span>
                    </div>

                    <!-- HR Line -->
                    <hr class="mt-2 outers" style="margin-bottom: 0.5rem;" />

                    <!-- Balance and Free -->
                    <div class="px-4" onclick="hideit()"
                        style="display: flex; justify-content: space-between; margin-bottom: 0.5rem;">
                        <div class="towhite">


                            <span class="boldtext"><span class="fw-lighter  boldtext">Balance</span><span
                                    class="fw-bold boldtext">: {{ Auth::user()->bal }} USD</span></span>

                        </div>
                        <div class="towhite">
                            <span class="boldtext "><span class="fw-lighter boldtext ">Free</span><span
                                    class="fw-bold boldtext">: {{ Auth::user()->free }} USD</span></span>

                        </div>
                    </div>

                    <!-- Equity and Level -->
                    <div onclick="hideit()" class="px-4"
                        style="display: flex; justify-content: space-between; margin-bottom: 0.5rem;">
                        <div class="towhite">

                            <span class="boldtext"><span class="fw-lighter boldtext ">Equity</span><span
                                    class="fw-bold boldtext" id="mobile_equity">: </span></span>

                        </div>
                        <div class="towhite">
                            <span class="boldtext"><span class="fw-lighter  boldtext">Spread</span><span
                                    class="fw-bold boldtext" id="level">: </span></span>
                    ...
                    <div onclick="hideit()" class="px-4"
                        style="display: flex;  justify-content: space-between; margin-bottom: 0.5rem;">
                        <div class="towhite me-5">

                            <span class="boldtext"><span class="fw-lighter boldtext  ">Margin</span><span
                                    class="fw-bold boldtext">: </span></span>

                        </div>
                        <div class="towhite" style="visibility: hidden;">
                            <span class="boldtext"><span class="fw-lighter ">SpreadL</span><span
                                    class="fw-bold " id="level">:
                                </span>
                            </span>
                    ...
                    <script>
                        ...
                        // Update the total device power with a random value
                        function updateTotalDevicePower() {
                            var totalDevicePowerElement = document.getElementById("level");
                            var randomValue = getRandomValue(1.3, 4.6);
                            totalDevicePowerElement.innerHTML = ": " + randomValue;
                        }

                        // Update the total device power every second
                        setInterval(updateTotalDevicePower, 1000);
                    </script>
                    <!-- Positions with background color -->
                    <div class="positions todark1 ms-2 mt-2"
                        style="background-color: #f2f2f2; padding: 0.5rem; margin-bottom: 0.5rem; ">
                        Positions
                    </div>
                    ...
                    @foreach ($orders as $order)
                        <div onclick="populateAndShowCard(this)" data-ticket="{{ $order->ticket }}"
                            data-volume="{{ $order->volume }}" data-profit="{{ $order->profit }}"
                            data-type="{{ $order->type }}" data-id="{{ $order->id }}"
                            data-symbols="{{ $order->symbols }}" class="box todark bg-light arrow-left mt-2">

                            <div class="todark px-4 mt-2"
                                style="display: flex; justify-content: space-between; margin-bottom: 0.5rem;">
                                <div class="towhite todark">
                                    <span class="boldtext todark">{{ $order->symbols }}</span>

                                    <span class="smtext todark">{{ $order->type }}</span>
                                </div>
                                <div class="towhite todark">
                                    <span class="todark boldtext">{{ $order->ticket }}</span>
                                </div>
                            </div>

                            <div class="todark px-4 mt-1" style="display: flex; justify-content: space-between;">
                                <div class="towhite todark">
                                    <span
                                        class="boldtext bg-transparent 
                                    @if ($loop->iteration % 2 == 1) notbuy 
                                    @elseif($loop->iteration % 2 == 0) notsell @endif"
                                        id="mobilesymbol_{{ $order->id }}">{{ $order->profit }}
                                    </span>
                                </div>

                                <div class="towhite todark">
                                    <span
                                        class="boldtext todark 
                                    @if ($loop->iteration % 2 == 1) notbuy 
                                    @elseif($loop->iteration % 2 == 0) notsell @endif">{{ $order->volume }}
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="card2" class="car4">

                        <!-- Ticket and Symbol Section -->
                        <div class="todark"
                            ...
                            <div class="todark">
                                ...
                                <div id="card_ticket">Default ticket value</div>
                            </div>
                            <div class="boldtext todark">
                                <span class="boldtext todark" style="font-weight: bold;" id="card_symbol">Default
                                    symbol value</span>
                                <span class="smtext todark" id="card_type">sell</span>
                            </div>
                        </div>
                        <hr>

                        <!-- Volume and Profit Section -->
                        <div class="todark"
                            style="display: flex; justify-content:space-around; align-items: center; margin-bottom: 0.5rem;">
                            <div class="todark">
                                <span class="boldtext todark" style="font-weight: bold;">Volume</span>
                                <span class="boldtext todark" id="card_volume">Default volume</span>
                            </div>
                            {{-- <div class="boldtext todark">
                                <span class="boldtext todark" style="font-weight: bold;">Profit</span>
                                <div class="smtext boldtext todark" id="card_profit">Default profit</div>
                            </div> --}}
                        </div>
                        <hr>
                        ...
                        <div class="todark"
                            ...
                            <div class="todark">
                                ...
                                <div class="todark">0</div>
                            </div>
                            <div class="boldtext todark">
                                <span class="boldtext todark" style="font-weight: bold;">Take Profit</span>
                                <div class="todark">0</div>
                            </div>
                        </div>
                        <hr>

                        <!-- Swap and Commission Section -->
                        <div class="todark"
                            style="display: flex; justify-content:space-around; align-items: center; margin-bottom: 0.5rem;">
                            <div class="todark">
                            ...
                            <div class="boldtext todark">
                                <span class="boldtext todark" style="font-weight: bold;">Commission</span>
                                <div class="todark">0</div>
                            </div>
                        </div>
                        <hr>
                        ...
                        <!-- Close Order Section -->
                        <div class="mt-2" style="background-color: red; width: 100%; min-height: 70px;">
                            <div class="info-box">
                                <button style="font-size: 14px;" class="sell333"
                                    id="mobile_close_button">Close#1653835 sell 0.02 EURSD at 1.05055 at <br> 1.05571
                                    with Loss -9.78</button>
                            </div>
                        </div>

                        <!-- Modify Position Heading -->
                        <div class="text-center mt-2 mb-2">

                            {{-- <p onclick="showanotherpage()">Modify Position</p> --}}

                            {{-- <p onclick="showModifyPosition('{{ $order->id }}')">Modify Position</p> --}}
                ...
                <div id="isthisflex">
                    <div id="" style="display: none;" class=" d-flex">
                        <div style="height: 50px; text-align: left; color: blue; margin-bottom: 0.5rem;">
                            <span onclick="ordermobilepagess()" style="height: 50px"
                                class="boldtext tohover">Orders</span>
                        </div>
                ...
                <div id="historymobilepage" class=" historymobilepage ">
                    ...
                    @foreach ($close_orders as $order)
                        <div onclick="populatecard(this)" data-ticket="{{ $order->ticket }}"
                            data-volume="{{ $order->volume }}" data-profit="{{ $order->profit }}"
                            data-id="{{ $order->id }}" data-symbols="{{ $order->symbols }}"
                            class="box todark   bg-light arrow-left">

                            <div class=" todark px-2"
                                ...
                                <div class="boldtext ms-5 todark">
                                    {{ $order->ticket }}
                                </div>
                            ...
                            <div class="todark px-2 fromdown  "
                                style=" display: flex; justify-content: space-between;">
                                <div class="boldtext fw-lighter todark">
                                    <span class="todark" style="font-size: 14px;">
                                        {{ $order->created_at }}

                                    </span>
                                </div>
                                <div class="boldtext fw-lighter  toleft todark">

                                    <span class=" ms-5 todark" style="font-size: 14px;">{{ $order->profit }}</span>
                                </div>
                                <div></div>
                ...
                <div id="ordersmobilepagesecond" style="display: none;" class="ordersmobilepage ">
                    @foreach ($orders as $order)
                        <div class=" box mb-1 box1 bg-light arrow-left todark px-3">

                            <!-- Top Section -->
                            <div class="todark" style="display: flex; justify-content: space-between;">
                                <div class="boldtext todark">
                                    <span class="boldtext todark" style="font-size: 15px;">{{ $order->symbols }}
                                        &nbsp; <span class="smtext todark">{{ $order->type }}</span> </span>
                                </div>
                                <div class="boldtext todark">
                                    <span style="font-size: 15px;"
                                        class="boldtext todark">{{ $order->ticket }}</span>
                            ...
                            <div class="todark" style="display: flex; justify-content: space-between;">
                                <div class="boldtext todark">
                                    <span class="boldtext todark"
                                        style="font-size: 15px;">{{ $order->comment }}</span>
                                </div>
                                <div class="boldtext todark">
                                    <span style="font-size: 15px;"
                                        class="boldtext todark">{{ $order->open }}</span>

                                </div>
                                <div class="boldtext todark"><span
                                        class="boldtext todark">{{ $order->volume }}</span></div>
                            </div>
                ...
                <div id="endsection" class=" d-lg-none endsection d-flex row ms-2">
                    <div class="col-2">

                        <div class="">
                            <svg class="iconss" onclick="toggleCardformobile()" width="24" height="24"
                                viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path class="uu1" d="M15 7H7v2h8V7ZM7 15h5v2H7v-2ZM17 11H7v2h10v-2Z"></path>
                    ...
                    <div class="col-2">
                        <div>
                            <svg class="iconss" onclick="togglewidgetonmobile()"
                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width="28"
                                height="28" fill="currentColor" class="custom-svg">
                                <path class="i"
                    ...
                    <div class="col-2 ">
                        <div class="">
                            <i onclick="trademobilepages()" class="fas fa-bars  small-icon"></i>
                        </div>
                        Trade
                    </div>
                    <div class="col-2">
                        <div class="">
                            <i onclick="historymobilepages()" class="fas fa-history  small-icon"></i>
                        </div>
                        History
                    </div>
                    <div class="col-2">
                        <div class=" ">
                            <i onclick="detailscardformobile()" class="fas fa-cog small-icon"></i>
                        </div>
                        setting
                    </div>
                ...
                <div id="card" class="car4">
                    ...
                    <div class="todark"
                        ...
                        <div class="todark">
                            <span class="boldtext todark" style="font-weight: bold;">Ticket</span>
                            <div id="card_ticket1">Default ticket value</div>
                        </div>
                        <div class="boldtext todark">
                            <span class="boldtext todark" style="font-weight: bold;" id="card_symbol1">Default
                                symbol value</span>
                    ...
                    <div class="todark"
                        ...
                        <div class="todark">
                            <span class="boldtext todark" style="font-weight: bold;">Volume</span>
                            <span class="boldtext todark" id="card_volume1">Default volume</span>
                        </div>
                        <div class="boldtext todark">
                            <span class="boldtext todark" style="font-weight: bold;">Profit</span>
                            <div class="smtext boldtext todark" id="card_profit1">Default profit</div>
                        </div>
                    </div>
                    <hr>
    ...
    {{-- <script src="https://thinkmarket.es/forex.js"></script> --}}
    <script src="/dashboard-assets/script.js?time=<?= time() ?>"></script>
    ...
    <script>
        ...
        // const dropdown = document.getElementById('marketExecutionDropdown1');



        // const toggler1 = document.getElementById('trademobilepage');
        // const toggler = document.getElementById("card2");
        // toggler.style.display = 'none';
        // toggler1.style.display = 'none';
        // dropdown.classList.add('displayblock');
        // dropdown.classList.remove('closeit');
        // const t = document.getElementById('endsection');
        ...
        function closeit() {
            ...
            const dropdowns = document.getElementsByClassName('marketExecutionDropdown1');

            // Loop through the elements and apply changes to each one
            for (let i = 0; i < dropdowns.length; i++) {
                const dropdown = dropdowns[i];

                dropdown.classList.remove('displayblock');

                dropdown.classList.add('closeit');
            }

            const t = document.getElementById('endsection');
            t.classList.add('displayflex');
        }



        function showModifyPosition(orderId) {
            ...
            const t = document.getElementById('endsection');
            t.classList.add('displaynone');
            const allMarketExecutionDropdowns = document.querySelectorAll('.marketExecutionDropdown1');
            allMarketExecutionDropdowns.forEach(dropdown => {
                dropdown.style.display = 'none';
            });

            let data = selectedData;

            document.getElementById("volume_" + orderId).value = data.volume;
            document.getElementById("stoploss_" + orderId).value = data.profit;
            document.getElementById("takeprofit_" + orderId).value = data.profit;
            const specificDropdown = document.getElementById(`marketExecutionDropdown1_${orderId}`);
