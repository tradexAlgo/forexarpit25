                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$docs->email}}</td>
                                            <td>{{$docs->password}}</td>
                                            <td>{{$docs->account_Id}}</td>
                                            <td><img src="{{asset('images')}}/{{$docs->image}}" alt="" style="border-radius:50%" width="80px"></td>
                                            <td><a href="{{url('view-document',$docs->id)}}" class="btn btn-outline-warning">View </a></td>
