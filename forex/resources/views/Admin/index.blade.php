                ...
                <div class="row g-4">
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                <p class="mb-2">Total Live Orders </p>
                                <h6 class="mb-0">{{$total_live_orders}}</h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                <p class="mb-2">Today Close Orders</p>
                                <h6 class="mb-0">{{$total_close_orders}}</h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                <p class="mb-2">Total Users Revenue</p>
                                <h6 class="mb-0">$ {{number_format($revenue, 2, '.', ',')}}</h6>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$user->password}}</td>
                                    <td>{{$user->bal}}</td>
                                     <td><a href="{{url('/edit-users',$user->id)}}" class="btn btn-warning">Change </a></td>
                                     <td><a href="{{url('/delete-user',$user->id)}}" class="btn btn-danger">Delete</a></td>
                ...
                <div class="bg-secondary rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="#">etcglobals</a>, All Right Reserved. 
                        </div>
