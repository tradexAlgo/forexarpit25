        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="index.html" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>ETCGLOBALS</h3>
                </a>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="/deposit" class="nav-item nav-link"><i class="fa fa-dollar-sign me-2"></i>Deposit</a>
                    <a href="/withdraw" class="nav-item nav-link active"><i class="fa fa-university me-2"></i>Withdraw</a>
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form action="{{route('make_withdraw')}}" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="bname" class="form-control" id="exampleInputPassword1">
                                </div>
