                ...
                <div id="firstcontent" class="row bordergive align-items-center firstrow text-dark">
                    <div class="dropdown">
                        ...
                        <div id="detailsCard" class="dropdown-menu rounded-0" aria-labelledby="dropdownMenuButton"
                            ...
                            <span class="text-center tex me-3">User</span>
                            <p class="tex1" style="color: green;">{{ Auth::user()->account_Id }} - {{ Auth::user()->name }}</p>
                        </div>

                                <div class="mb-2 px-3 border-top-0 py-1 profile">
                                    <i class="fas fa-user" style="color: grey;"></i>

                                    <a style="text-decoration: none; color: black;" href="/change-login">Change Password</a>
                                </div>

                                <div class="mb-2 border-top-0 px-3 py-1 profile">
                                    <i class="fas fa-link mr-2" style="color: grey;"></i>

                                    <a style="text-decoration: none; color: black;" href="/login">Connect to Account</a>
                                </div>
...
window.location.href = '/withdraw';
    ...
    window.location.href = '/deposit';
                        ...
                        <div id="marketExecutionDropdown" class="dropdown-menu dropdown-container rounded-0"
                            ...
                            <div class="content1">
                                ...
                                <div class="buttons-row">
                                    <button  style="font-size: 14px;" class="sell333" type="submit" name="action" value="sel_market">Sell by Market</button>
                                    <button style="font-size: 14px;" class="buy333" type="submit" name="action" value="buy_market">Buy by Market</button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="margingiving"
                        ...
                        <svg class="one1 " onclick="toggleDropdown()" width="24" height="24" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
...
function createTradingViewWidget(theme , symbol) {
                    ...
                    <div class="card-body">
                        ...
                        <div class="dropdown-card6" id="dropdowncard6">
                            ...
                            <div class="dropdown-row1">
                                ...
                                <div class="description1">	ADA</div>
                            </div>
                            <div class="dropdown-row1">
                                <div class="dropdown-row2">
                            ...
                            <div class="dropdown-row1">
                                <div class="dropdown-row2">
                                    <span class="description">tezos</span>
                                    <button class="toggle-btn" onclick="toggleIcon(this)"><i
                                            class="fas fa-plus"></i></button>
                                </div>
                                <div class="description1">XTZ </div>
                            </div>
                            ...
                            <div class="dropdown-row1">
                                <div class="dropdown-row2">
                                    <span class="description">zcash</span>
                                    <button class="toggle-btn" onclick="toggleIcon(this)"><i
                                            class="fas fa-plus"></i></button>
                                </div>
                                <div class="description1">ZEC </div>
                            </div>
                            ...
                            <div class="dropdown-row1">
                                <div class="dropdown-row2">
                                    <span class="description">omisego</span>
                                    <button class="toggle-btn" onclick="toggleIcon(this)"><i
                                            class="fas fa-plus"></i></button>
                                </div>
                                <div class="description1">OMG </div>
                            </div>
                            ...
                            <div class="dropdown-row1">
                                <div class="dropdown-row2">
                                    <span class="description">vechain</span>
                                    <button class="toggle-btn" onclick="toggleIcon(this)"><i
                                            class="fas fa-plus"></i></button>
                                </div>
                                <div class="description1">VET </div>
                            </div>
                            ...
                            <div class="dropdown-row1">
                                <div class="dropdown-row2">
                                    <span class="description">qtum</span>
                                    <button class="toggle-btn" onclick="toggleIcon(this)"><i
                                            class="fas fa-plus"></i></button>
                                </div>
                                <div class="description1">QTUM </div>
                            </div>
                            ...
                            <div class="dropdown-row1">
                                <div class="dropdown-row2">
                                    <span class="description">bitshares</span>
                                    <button class="toggle-btn" onclick="toggleIcon(this)"><i
                                            class="fas fa-plus"></i></button>
                                </div>
                                <div class="description1">BTS </div>
                            </div>
                            ...
                            <div class="dropdown-row1">
                                <div class="dropdown-row2">
                                    <span class="description">lisk</span>
                                    <button class="toggle-btn" onclick="toggleIcon(this)"><i
                                            class="fas fa-plus"></i></button>
                                </div>
                                <div class="description1">LSK </div>
                            </div>
                            ...
                            <div class="dropdown-row1">
                                ...
                                <div class="description1">DCR </div>
                            </div>
                            ...
                            <div class="dropdown-row1">
                                <div class="dropdown-row2">
                                    <span class="description">zilliqa</span>
                                    <button class="toggle-btn" onclick="toggleIcon(this)"><i
                                            class="fas fa-plus"></i></button>
                                </div>
                                <div class="description1">ZIL </div>
                            </div>
                            ...
                            <div class="dropdown-row1">
                                <div class="dropdown-row2">
                                    <span class="description">aeternity</span>
                                    <button class="toggle-btn" onclick="toggleIcon(this)"><i
                                            class="fas fa-plus"></i></button>
                                </div>
                                <div class="description1">AE </div>
                            </div>
                            ...
                            <div class="dropdown-row1">
                                ...
                                <div class="description1">MKR </div>
                            </div>
            ...
            <!-- TradingView Widget END -->
                    ...
                    <table class="table border-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td id="symbol_{{$order->id}}" data-value="{{$order->profit}}"  data-column="Profit">
                                     <div class="towhite todark">
                                    <div class="towhite todark">
                                        <span class="boldtext bg-transparent 
                                            @if($loop->iteration % 2 == 1) notbuy 
                                            @elseif($loop->iteration % 2 == 0) notsell 
                                            @endif" 
                                           >{{ $order->profit }}
                                        </span>
                                    </div>
                ...
                <div id="trademobilepage"  class="trademobilepage" style="padding: 1rem; font-size: 1rem;">
                    ...
                    <!-- Centered -1.64 EUR -->
                    <div onclick="hideit()" class="togivered" style="text-align: center; color: red; margin-bottom: 0.5rem;">
                        <span class="smtext">
                    ...
                    <!-- Balance and Free -->
                    <div class="px-4" onclick="hideit()" style="display: flex; justify-content: space-between; margin-bottom: 0.5rem;">
                        <div class="towhite">
                    ...
                    <!-- Equity and Level -->
                    <div onclick="hideit()" class="px-4" style="display: flex; justify-content: space-between; margin-bottom: 0.5rem;">
                        <div class="towhite">
                        ...
                        <div class="towhite">
                            <span class="boldtext"><span class="fw-lighter  boldtext">Level</span><span
                    ...
                    <div onclick="hideit()" class="px-4" style="display: flex;  justify-content: space-between; margin-bottom: 0.5rem;">
                        ...
                        <div class="towhite" style="visibility: hidden;">
                            <span class="boldtext"><span class="fw-lighter ">Level</span><span class="fw-bold " id="level">:
                                 </span>
                                </span>
        ...
        function updateTotalDevicePower() {
          ...
          var randomValue = getRandomValue(0.971, 1.167);
        ...
        setInterval(updateTotalDevicePower, 1000);
                    ...
                    @foreach ($orders as $order)
                    <div onclick="populateAndShowCard(this)" 
                         data-ticket="{{ $order->ticket }}" 
                         data-volume="{{ $order->volume }}" 
                         data-profit="{{ $order->profit }}" 
                         data-type="{{ $order->type }}" 
                         data-id="{{ $order->id }}" 
                         data-symbols="{{ $order->symbols }}" 
                         class="box todark bg-light arrow-left mt-2">
                    
                        <div class="todark px-4 mt-2" style="display: flex; justify-content: space-between; margin-bottom: 0.5rem;">
                            <div class="towhite todark">
                    ...
                    <div id="card2" class="car4">
                        ...
                        <div class="todark" style="display: flex; justify-content: space-around; align-items: center; margin-bottom: 0.5rem;">
                            <div class="todark">
                            ...
                            <div class="boldtext todark">
                                <span class="boldtext todark" style="font-weight: bold;" id="card_symbol">Default symbol value</span>
                        ...
                        <div class="mt-2" style="background-color: red; width: 100%; min-height: 70px;">
                            <div class="info-box">
                                <button style="font-size: 14px;" class="sell333" id="mobile_close_button" >Close#1653835 sell 0.02 EURSD at 1.05055 at <br> 1.05571 with Loss -9.78</button>
                            </div>
                        </div>
                ...
                <div id="isthisflex">
                    <div id="" style="display: none;" class=" d-flex">
                        <div style="height: 50px; text-align: left; color: blue; margin-bottom: 0.5rem;">
                            <span onclick="ordermobilepagess()" style="height: 50px" class="boldtext tohover">Orders</span>
                        </div>
                ...
                <div id="historymobilepage" class=" historymobilepage ">
                    ...
                    <div onclick="populatecard(this)" 
                    data-ticket="{{ $order->ticket }}" 
                    data-volume="{{ $order->volume }}" 
                    data-profit="{{ $order->profit }}" 
                    data-id="{{ $order->id }}" 
                    data-symbols="{{ $order->symbols }}"    class="box todark   bg-light arrow-left">
                        ...
                        <div class="todark px-2 fromdown  " style=" display: flex; justify-content: space-between;">
                ...
                <div id="ordersmobilepagesecond" style="display: none;" class="ordersmobilepage ">
                    ...
                    <div class=" box mb-1 box1 bg-light arrow-left todark px-3">
                        ...
                        <div class="todark" style="display: flex; justify-content: space-between;">
                            <div class="boldtext todark">
                                <span class="boldtext todark" style="font-size: 15px;">{{$order->symbols}} &nbsp;        <span class="smtext todark">{{$order->type}}</span> </span>
                            </div>
                            <div class="boldtext todark">
                        ...
                        <div class="todark" style="display: flex; justify-content: space-between;">
                            <div class="boldtext todark">
                                <span class="boldtext todark" style="font-size: 15px;">{{$order->comment}}</span>
                            </div>
                            <div class="boldtext todark">
                                <span style="font-size: 15px;" class="boldtext todark">{{$order->open}}</span>
                    ...
                    <div id="endsection" class=" d-lg-none endsection d-flex row ms-2">
                        ...
                        <div class="col-2">
                            <div>
                                <svg class="iconss" onclick="togglewidgetonmobile()" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 28 28" width="28" height="28" fill="currentColor" class="custom-svg">
                                    <path class="i"
                ...
                @endif
                    ...
                    <div id="card" class="car4">
                        ...
                        <div class="todark" style="display: flex; justify-content: space-around; align-items: center; margin-bottom: 0.5rem;">
                            ...
                            <div class="boldtext todark">
                                <span class="boldtext todark" style="font-weight: bold;" id="card_symbol1">Default symbol value</span>
