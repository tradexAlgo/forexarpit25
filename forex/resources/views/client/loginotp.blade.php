    ...
    <div id="container1" class="container container1  mt-5">
        ...
        <div class="d-flex  justify-content-center align-items-center">
            ...
            <div class="card1  responsive-card">
                <div class="title  padding text-light">Trading accounts: Etcglobals</div>
                ...
                <h4 class="p-3">Hi {{Auth::user()->name}} Enter Otp You received to the email {{Auth::user()->email}}  </h4>
                <form action="{{ route('loginotp') }}" method="POST">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between mx-1 p-3">
                        <label class="fw-bolder" for="">OTP Code </label>
                        <input class="bg-light"type="text" name="confirm_otp">
                    </div>
