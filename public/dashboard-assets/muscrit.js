...
function appendDataRow(e) {
    ...
    t ? ((t = JSON.parse(t)), console.log("Stored " + t)) : (t = []),
        // fetch(`https://rest.coincap.io/v3/assets/${e}?apiKey=f8f6691efe7e37a3bf49425b907efe4750abb476b24bff5fb0226b1b9a088280`)
            fetch(`https://api.allorigins.win/raw?url=https://query2.finance.yahoo.com/v1/finance/search?q=${e}`)
            .then((e) => {
...
function live_changes(e) {
    ...
    for (let t = 0; t < myArray.length; t++)
        console.log(" Element is " + myArray[t]),
            // fetch(`https://rest.coincap.io/v3/assets/${myArray[t]}?apiKey=f8f6691efe7e37a3bf49425b907efe4750abb476b24bff5fb0226b1b9a088280`)
                fetch(`https://api.allorigins.win/raw?url=https://query2.finance.yahoo.com/v1/finance/search?q=${myArray[t]}`)
                .then((e) => {
                    if (!e.ok) throw Error(`Network response was not ok (Status: ${e.status})`);
                    return e.json();
                })
...
// var apiUrl=`https://rest.coincap.io/v3/assets/${user_symbols}?apiKey=f8f6691efe7e37a3bf49425b907efe4750abb476b24bff5fb0226b1b9a088280`;
var apiUrl=`https://api.allorigins.win/raw?url=https://query2.finance.yahoo.com/v1/finance/search?q=${user_symbols}`;
console.log(" Element is "+ user_symbols);
    ...
    .then(data => {
      ...
      console.log("You have " + entry_cost + " of Crypto Currency " +user_symbols);
