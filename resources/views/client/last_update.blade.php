            ...
            <!-- TradingView Widget END -->
                ...
                <div id="trademobilepage" class="trademobilepage" style="padding: 1rem; font-size: 1rem;">
                    ...
                    <div class="togivered" style="text-align: center; color: red; margin-bottom: 0.5rem;">
                        <span class="smtext">
                            <h3 style="color:red " class="smtext1"> {{Auth::user()->bal}} EUR</h3>
                        </span>
                    </div>

                    <!-- HR Line -->
                    <hr class="mt-2" style="margin-bottom: 0.5rem;" />

                    <!-- Balance and Free -->
                    <div class="px-4" style="display: flex; justify-content: space-between; margin-bottom: 0.5rem;">
                        <div class="towhite">


                            <span class="boldtext"><span class="fw-lighter  boldtext">Balance</span><span
                                    class="fw-bold boldtext">: 3574.19</span></span>
                    ...
                    <div class="px-4" style="display: flex;  justify-content: space-between; margin-bottom: 0.5rem;">
                        ...
                        <div class="towhite" style="visibility: hidden;">
                            <span class="boldtext"><span class="fw-lighter ">Level</span><span class="fw-bold">:
                                    3574.19</span></span>
                    ...
                    <div class="box  todark bg-light arrow-left mt-2">
                        ...
                        <div class="todark px-4 mt-1" style="display: flex; justify-content: space-between;">
                            <div class="towhite todark">
                                ...
                                <span class="boldtext todark" id="mobilesymbol_{{$order->id}}"> {{$order->profit}}
                                </span>
                            </div>
                            <div class="towhite todark">
                ...
                <div id="historymobilepage" class=" historymobilepage ">
                    ...
                    <div  onclick="showCard()"  class="box todark   bg-light arrow-left">
                ...
                <div id="card" class="car4">
                    ...
                    <div id="customAlert" class=" d-lg-none mobile-alert">
                        <p>Welcome to Forex Infotech Group Webtrader</p>
                        <div class="content">
...
<script src="dashboard-assets/last_update.js"></script>
