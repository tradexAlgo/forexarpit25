                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Change Users Details </h6>
                            <form action="{{route('update_user')}}" method="post">
                                @method('PUT')
                                @csrf
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Name</label>
                                    <input type="text" name="name" class="form-control" value="{{$name}}" id="exampleInputEmail1">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="email" class="form-control" value="{{$email}}" id="exampleInputEmail1">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="password" class="form-control" value="{{$password}}" id="exampleInputEmail1">
                                   
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Balance</label>
                                    <input type="text" name="bal" class="form-control" value="{{$bal}}" id="exampleInputEmail1">
                            ...
                            <div class="bg-secondary rounded-top p-4">
                                <div class="row">
                                    <div class="col-12 col-sm-6 text-center text-sm-start">
                                        &copy; <a href="{{url('/')}}">ETCGBLOBALS</a>, All Right Reserved. 
                                    </div>
